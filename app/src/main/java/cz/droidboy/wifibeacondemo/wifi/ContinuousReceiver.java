package cz.droidboy.wifibeacondemo.wifi;
...
public class ContinuousReceiver extends BroadcastReceiver {
     ...
     */
    public ContinuousReceiver(Context context, ScanResultsListener listener) {
     ...
     */
    public ContinuousReceiver(Context context, ScanResultsListener listener, int scanInterval) {
        if (context == null) {
